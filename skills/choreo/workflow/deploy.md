...
- run `/choreo:cancel` — abort this workflow, you'll handle it manually
```
...
- If the user wants to abort, they use `/choreo:cancel`. Don't try to "auto-rollback" from this stage.