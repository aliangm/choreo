...
> This file is the canonical protocol for the `executing` stage. The main agent launches `choreo:workflow-subagent` with this file as the stage instructions; the subagent reads this file first before doing anything.
