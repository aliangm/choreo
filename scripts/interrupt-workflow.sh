...
# Resume with: /choreo:continue
# Cancel entirely with: /choreo:cancel
#
...
if [[ "$STATUS" == "interrupted" ]]; then
  ...
  echo "   Resume with: /choreo:continue" >&2
  echo "   Cancel with: /choreo:cancel" >&2
  exit 0
fi
...
# /choreo:continue (which sees a "fresh" report and auto-advances).
...
# on the next /choreo:continue would see them and assume something
...
echo ""
echo "   Resume with: /choreo:continue"
echo "   Cancel entirely with: /choreo:cancel"
